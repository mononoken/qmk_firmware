...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_BASE] = LAYOUT(
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    NUMWORD, KC_DEL,  NUMP,    NUMWORD, KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, _______,
                                 xxxxxxx, NAV,     LMOD,    KC_SPC,  KC_ENT,  KC_BSPC, REPEAT,  RMOD,    NUM,     xxxxxxx
    ),
    [_NUM] = LAYOUT(
